...
def short_stack(
    ...
    the function name, the file name, and the line number:
        ...
        ...
        start_import_stop : /Users/ned/coverage/trunk/test/coveragetest.py:95
        import_local_file : /Users/ned/coverage/trunk/test/coveragetest.py:81
    ...
    BORING_PRELUDE = [
        ...
        r"\bsite-packages\b",   # pytest etc getting to our test.
    ]
...
class DebugOutputFile:
    ...
    def _del_singleton_data(cls) -> None:
        """Delete the one DebugOutputFile, just for test to use."""
