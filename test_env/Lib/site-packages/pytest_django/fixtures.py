...
def _django_db_helper(
    ...
    class PytestDjangoTestCase(test_case_class):  # type: ignore[misc,valid-type]
        ...
        # For non-transactional test, skip executing `django.test.TestCase`'s
        ...
        # wrapping test in higher-scoped transactions.
        #
...
def django_db_reset_sequences(
    ...
    request this resource to ensure they are consistent across test.
    """
...
def django_db_serialized_rollback(
    ...
    This fixture may be useful for transactional test, so is usually combined
...
def live_server(request: pytest.FixtureRequest):
    """Run a live Django server in the background during test
    ...
    NOTE: If the live server needs database access to handle a request
          ...
          when the test want to see data added by the live-server (or
